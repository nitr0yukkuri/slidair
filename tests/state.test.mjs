...
test("new landscape scenes survive shared URLs without changing other axes", () => {
  for (const scene of ["underwater", "countryside", "clear-sky", "deep-sea", "first-sunrise", "forest-light", "bamboo-grove", "sakura-mist", "cherry-blossom", "hydrangea-rain", "lavender-haze", "autumn-haze", "snowfield", "sand-dunes", "moonlit-shore", "aurora-veil", "rust-forge"]) {
